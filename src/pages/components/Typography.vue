      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-md-2 mr-auto ml-auto">
            ...
            <img src="img/faces/kaci-baum-2.jpg" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
            <p class="text-center">Brigitte Bardot</p>
          </div>
          <div class="col-sm-3 col-md-2 mr-auto">
            <h4 class="images-title">Thumbnail</h4>
            <img src="img/faces/erik-lucatero-2.jpg" class="img-thumbnail img-responsive" alt="Rounded Image">
